...
if IsDuplicityVersion() then
    ...
    client = {
        ...
        imagepath = GetConvar('inventory:imagepath', 'nui://bpt_inventory/web/images'),
...
if not lib then
    return spamError('bpt_inventory requires the ox_lib resource.')
end
