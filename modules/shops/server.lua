...
local function setupShopItems(id, shopType, shopName, groups)
	local shop = id and Shops[shopType][id] or Shops[shopType] --[[@as BptShop]]
...
---@param shopType string
---@param shopDetails BptShop
exports('RegisterShop', function(shopType, shopDetails)
	registerShopType(shopType, shopDetails)
end)

lib.callback.register('bpt_inventory:openShop', function(source, data)
...
lib.callback.register('bpt_inventory:buyItem', function(source, data)
