...
AddEventHandler('esxplayerDropped', playerDropped)

AddEventHandler('esxsetJob', function(source, job, lastJob)
...
SetTimeout(500, function()
	ESX = exports.es_extendedgetSharedObject()

	if ESX.CreatePickup then
		error('bpt_inventory requires a ESX Legacy v1.6.0 or above, refer to the documentation.')
	end
...
function server.buyLicense(inv, license)
	...
	TriggerEvent('esx_licenseaddLicense', inv.id, license.name)

	return true, 'have_purchased'
end

--- Takes traditional item data and updates it to support bpt_inventory, i.e.
--- ```
--- Old {cola1, burger3}
--- New [{slot1,namecola,count1}, {slot2,nameburger,count3}]
---```
---@diagnostic disable-next-line duplicate-set-field
