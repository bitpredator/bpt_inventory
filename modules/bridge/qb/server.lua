...
local function setupPlayer(Player)
	...
	QBCore.Functions.AddPlayerMethod(Player.PlayerData.source, "SetInventory", function()
		-- bpt_inventory's item structure is not compatible with qb-inventory's one so we don't support it
		error('Player.Functions.SetInventory is unsupported for bpt_inventory. Try ClearInventory, then add the desired items.')
	end)
end
