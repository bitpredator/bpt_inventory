...
local Items = require 'modules.items.shared' --[[@as table<string, BptClientItem>]]
...
---@cast Items +fun(itemName: string): BptClientItem
---@cast Items +fun(): table<string, BptClientItem>
...
local bpt_inventory = exports[shared.resource]
-----------------------------------------------------------------------------------------------
...
Item('bandage', function(data, slot)
	...
	bpt_inventory:useItem(data, function(data)
		if data then
