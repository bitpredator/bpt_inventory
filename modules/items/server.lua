...
local Items = {}
local ItemList = require 'modules.items.shared' --[[@as table<string, BptServerItem>]]
local Utils = require 'modules.utils.server'

TriggerEvent('bpt_inventory:itemList', ItemList)
...
---@cast Items +fun(itemName: string): BptServerItem
---@cast Items +fun(): table<string, BptServerItem>
